...
export const getButtonClasses = (
  ...
  clsx({
    "box-border font-normal leading-36px text-14px inline-flex items-center rounded-full focus:outline-none transition-colors transition-shadow duration-300":
      true,
    ...
    "px-8 py-2": size === ButtonSizes.Medium,
